  ...
  return (
      <div className="w-full max-w-sm bg-white rounded-lg shadow-md p-8">
        <div className="flex justify-center">
          <svg viewBox="0 0 75 24" width="75" height="24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="mx-auto mb-4">
            <g id="qaEJec">
            ...
            <g id="vbkDmc"><path fill="#ea4335" d="M25.17 6.71c-3.28 0-5.954 2.505-5.954 5.958 0 3.433 2.673 5.96 5.954 5.96 3.282 0 5.955-2.527 5.955-5.96 0-3.453-2.673-5.96-5.955-5.96zm0 9.567c-1.8 0-3.35-1.487-3.35-3.61 0-2.14 1.55-3.608 3.35-3.608s3.35 1.46 3.35 3.61c0 2.12-1.55 3.61-3.35 3.61z"></path></g>
        ...
        <h2 className="text-2xl font-normal text-center mb-2">Iniciar sesión</h2>
        <p className="text-sm text-center mb-8">Utiliza tu cuenta de Google</p>
