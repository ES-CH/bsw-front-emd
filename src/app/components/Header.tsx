    ...
    <>
      <header className="bg-gray-100 p-5">
        <div className="container mx-auto flex justify-between items-center">
            <svg viewBox="0 0 75 24" width="75" height="24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="mx-auto">
                <g id="qaEJec">
            ...
            <nav>
                <ul className="flex space-x-6">
                    <li>
                        <button onClick={() => handlelogut()} className="text-gray-600 hover:text-gray-900">Cerrar sesion</button>
                    </li>        
                </ul>
            </nav>
        </div>        
